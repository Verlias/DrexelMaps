...
function InputMain() {
    ...
    }, [startingLocationSuggestions, showForm]);
    ...
    }, [endingLocationSuggestions, showForm]);
    ...
    const handleInputChange = (event, setValue, setSuggestions) => {
        ...
        if (value.trim() === '') {
            setSuggestions(buildingData.map(building => building.name).sort());
            return;
        }
    ...
    return (
        <>
            {!showForm && (
                <button className={styles.formOpen} onClick={openForm}>
                    <img className={styles.searchIcon} src={searchIcon} alt="Search" />
                </button>
            )}
            {showForm && (
                <form className={styles.form} onSubmit={handleSubmit}>
                    <button className={styles.formClose} onClick={closeForm}>
                    ...
                    <label className={styles.spacedLabel} htmlFor="enddestination">Ending Class Location:</label>
                    ...
                    <label className={styles.spacedLabel} htmlFor="classNumber">Class Number:</label>
                    <input id="classNumber" name="classNumber" onChange={(e) => setRoomnumber(e.target.value)} />
