try {
    ...
    class Node {
        ...
        checkName() {
            const location = this.name.toLowerCase();
            return (
                location === "road" ||
                location === "entrance" ||
    ...
    class PriorityQueue {
        ...
        astar() {
            ...
            if (this.top != this.end) {
                if (this.top.checkName() || this.top === this.start || this.top === this.end) {
    ...
    async function fetchNodes() {
        try {
            const response = await fetch("building_locations.json");
            if (!response.ok) {
